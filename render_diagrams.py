...
# Inspired by Herberto Graça Explicit Architecture & WATA Factory specs
...
try:
    ...
    box_title_font = ImageFont.truetype("/System/Library/Fonts/Helvetica.ttc", 22)
    box_body_font = ImageFont.truetype("/System/Library/Fonts/Helvetica.ttc", 17)
...
# =============================================================
# 1. DIAGRAM 1: HERBERTO GRAÇA EXPLICIT ARCHITECTURE FOR SATELLITE
# =============================================================
img0, draw0 = create_image(1600, 900)

draw0.text((60, 30), "HERBERTO GRAÇA EXPLICIT ARCHITECTURE — SATELLITE SYSTEM MAPPING", font=title_font, fill=(248, 250, 252))
draw0.text((60, 75), "Synthesizing DDD + Hexagonal + Onion Architecture into explicit application boundaries", font=subtitle_font, fill=(148, 163, 184))

# Vertical dividing dashed line
for y in range(120, 860, 20):
    draw0.line([(800, y), (800, y + 10)], fill=(71, 85, 105), width=2)

draw0.text((250, 120), "PRIMARY / DRIVING ADAPTERS", font=box_title_font, fill=(59, 130, 246))
draw0.text((950, 120), "SECONDARY / DRIVEN ADAPTERS", font=box_title_font, fill=(16, 185, 129))

# User Interface Outer Layer (Left - Light Green)
draw_rounded_rect(draw0, (60, 160, 420, 840), 16, (20, 83, 45), (34, 197, 94), 3)
draw0.text((80, 180), "USER INTERFACE / DRIVING", font=box_title_font, fill=(248, 250, 252))

draw_rounded_rect(draw0, (80, 240, 400, 480), 10, (15, 23, 42), (59, 130, 246), 2)
draw0.text((95, 255), "REST Controllers\n(SatelliteController.java)", font=box_body_font, fill=(248, 250, 252))
draw0.text((95, 320), "• POST /api/v1/satellites\n• PUT /telemetry\n• GET /satellites/{id}\n• SatelliteRestMapper.java", font=small_font, fill=(148, 163, 184))

draw_rounded_rect(draw0, (80, 520, 400, 800), 10, (15, 23, 42), (59, 130, 246), 2)
draw0.text((95, 535), "CLI & Stream Consumer\n(TelemetryConsumer.java)", font=box_body_font, fill=(248, 250, 252))
draw0.text((95, 600), "• Ingests Kafka Stream\n• Console Command Triggers\n• Maps Stream Payloads", font=small_font, fill=(148, 163, 184))

# Application Core Center Ring (Hexagon Outer - Red)
draw_rounded_rect(draw0, (460, 160, 1140, 840), 20, (127, 29, 29), (239, 68, 68), 4)
draw0.text((480, 180), "APPLICATION CORE (Hexagon Boundary)", font=box_title_font, fill=(248, 250, 252))

# Application Layer (Yellow Middle)
draw_rounded_rect(draw0, (480, 230, 1120, 420), 14, (120, 53, 15), (245, 158, 11), 3)
draw0.text((500, 245), "APPLICATION LAYER (com.satellite.application.service)", font=box_title_font, fill=(248, 250, 252))
draw0.text((500, 290), "Use Cases & App Services:\n  • LaunchSatelliteService.java\n  • UpdateTelemetryService.java\n  • GetSatelliteService.java", font=box_body_font, fill=(248, 250, 252))

# Domain Layer (Red Center)
draw_rounded_rect(draw0, (480, 450, 1120, 810), 14, (15, 23, 42), (239, 68, 68), 3)
draw0.text((500, 465), "DOMAIN LAYER (com.satellite.domain)", font=box_title_font, fill=(248, 250, 252))
draw0.text((500, 515), "AGGREGATE ROOT: Satellite.java (State Machine)\nVALUE OBJECTS: Orbit.java, Telemetry.java, SatelliteId.java\nDOMAIN EVENTS: SatelliteLaunchedEvent, AnomalyDetectedEvent\nINBOUND PORTS: LaunchSatelliteUseCase, UpdateTelemetryUseCase\nOUTBOUND PORTS: SatelliteRepository, SatelliteEventPublisher", font=small_font, fill=(248, 250, 252))

# Infrastructure Outer Layer (Right - Orange/Brown)
draw_rounded_rect(draw0, (1180, 160, 1540, 840), 16, (30, 41, 59), (71, 85, 105), 3)
draw0.text((1200, 180), "INFRASTRUCTURE ADAPTERS", font=box_title_font, fill=(16, 185, 129))

draw_rounded_rect(draw0, (1200, 240, 1520, 410), 10, (15, 23, 42), (16, 185, 129), 2)
draw0.text((1215, 255), "JPA ORM Adapter\n(SatelliteJpaAdapter.java)", font=box_body_font, fill=(248, 250, 252))
draw0.text((1215, 320), "• Implements SatelliteRepository\n• H2 / PostgreSQL DB", font=small_font, fill=(148, 163, 184))

draw_rounded_rect(draw0, (1200, 440, 1520, 610), 10, (15, 23, 42), (245, 158, 11), 2)
draw0.text((1215, 455), "MongoDB Adapter\n(SatelliteMongoAdapter.java)", font=box_body_font, fill=(248, 250, 252))
draw0.text((1215, 520), "• Implements SatelliteRepository\n• NoSQL BSON Collections", font=small_font, fill=(148, 163, 184))

draw_rounded_rect(draw0, (1200, 640, 1520, 810), 10, (15, 23, 42), (168, 85, 247), 2)
draw0.text((1215, 655), "Event Bus Adapter\n(EventPublisherAdapter)", font=box_body_font, fill=(248, 250, 252))
draw0.text((1215, 720), "• Implements EventPublisher\n• Spring / RabbitMQ Event Bus", font=small_font, fill=(148, 163, 184))

# Arrows
draw_arrow(draw0, (400, 360), (480, 320), (59, 130, 246), 4)
draw_arrow(draw0, (400, 660), (480, 630), (59, 130, 246), 4)

draw_arrow(draw0, (1120, 630), (1200, 325), (16, 185, 129), 4)
draw_arrow(draw0, (1120, 630), (1200, 525), (245, 158, 11), 4)
draw_arrow(draw0, (1120, 630), (1200, 725), (168, 85, 247), 4)

img0.save("/Users/bipin/.gemini/antigravity/scratch/satellite-system/diagram_explicit_architecture.png")

# =============================================================
# 2. DIAGRAM 1: HEXAGONAL PRIMARY & SECONDARY ADAPTERS (WATA / Herberto Graça Style)
# =============================================================
...
# =============================================================
# 3. DIAGRAM 2: ONION ARCHITECTURE CONCENTRIC RINGS
# =============================================================
...
# =============================================================
# 4. DIAGRAM 3: DDD UBIQUITOUS LANGUAGE & SUBDOMAINS
# =============================================================
...
# =============================================================
# 5. DIAGRAM 4: DUAL DATABASE ADAPTER SWAPPING DEMO
# =============================================================
...
print("Successfully generated all 5 HD diagram PNGs including Herberto Graca Explicit Architecture!")
